    ...
    >
      ...
      <div className="p-4 border-t border-unity-light-gray dark:border-unity-darker">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-unity-purple hover:bg-unity-purple/10 rounded-lg transition-colors"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
  ...
  return (
    <div
      className={cn(
        ...
        'hover:bg-gray-50 dark:hover:bg-unity-darker/50',
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-unity-dark-gray dark:text-white truncate">
            {participant.name}
            {isLocal && (
        ...
        <div className="flex items-center gap-2 mt-0.5">
          ...
          {participant.isScreenSharing && (
            <span className="text-xs text-unity-purple flex items-center gap-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      {onPin && !isLocal && (
        <div className="opacity-0 group-hover:opacity-100 transition-opacity">
          <Tooltip content="Fijar participante">
            <button
              onClick={onPin}
              className="p-1.5 rounded-lg text-gray-400 hover:text-unity-purple hover:bg-unity-purple/10 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
